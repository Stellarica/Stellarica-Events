...
import net.stellarica.events.event.block.BlockBreakEvent
import net.stellarica.events.event.block.BlockUseEvent
import net.stellarica.events.event.entity.EntityUseEvent
import net.stellarica.events.event.item.ItemUseEvent
import net.stellarica.events.event.player.PlayerAttackEntityEvent
import net.stellarica.events.event.player.PlayerChatEvent
import net.stellarica.events.event.server.EndServerTickEvent
import net.stellarica.events.event.server.StartServerTickEvent
import org.quiltmc.loader.api.ModContainer
import org.quiltmc.qsl.base.api.entrypoint.server.DedicatedServerModInitializer
import org.quiltmc.qsl.lifecycle.api.event.ServerTickEvents

@Suppress("unused")
class StellaricaEventsInitializer : DedicatedServerModInitializer {
